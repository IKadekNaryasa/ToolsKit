...
<head>
    ...
    <title>Change Password For First Time</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-danger ">*Change Password For First Time</small>
                        <!-- /Logo -->

                        <form id="formAuthentication" class="my-3" action="{{ route('auth.changePasswordFirstTime') }}" method="POST">
                            @csrf
